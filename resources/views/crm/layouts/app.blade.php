...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('crm-assets/vendors/css/daterangepicker.min.css') }}" />
    <!--! END: Vendors CSS-->
    <!--! BEGIN: Custom CSS-->
...
<script src="{{ asset('crm-assets/vendors/js/daterangepicker.min.js') }}"></script>
<script src="{{ asset('crm-assets/vendors/js/apexcharts.min.js') }}"></script>
<script src="{{ asset('crm-assets/vendors/js/circle-progress.min.js') }}"></script>
    <!--! END: Vendors JS !-->
    <!--! BEGIN: Apps Init  !-->
<script src="{{ asset('crm-assets/js/common-init.min.js') }}"></script>
<script src="{{ asset('crm-assets/js/dashboard-init.min.js') }}"></script>
    <!--! END: Apps Init !-->
    <!--! BEGIN: Theme Customizer  !-->
<script src="{{ asset('crm-assets/js/theme-customizer-init.min.js') }}"></script>
    <!--! END: Theme Customizer !-->
    @stack('scripts')
</body>
